...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("La direccion Ip del servidor es" +
                InetAddress.getLocalHost());
        System.out.println("El puerto local del servidor es " +
        ...
        PrintWriter toNetwork = new PrintWriter(serverSideSocket.getOutputStream(),
                true);
